...
public class PayActivity extends BaseActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    public void initView() {
        ...
        mEtAgent = (EditText) findViewById(R.id.et_agent);
        initData();
    }
...
//        }
    ...
    private void subOrder() {
        ...
        String agent = mEtAgent.getText().toString();
        ...
        mOrderBean.setUserId(mUser.getUserId());
        mOrderBean.setPhone(phone);
        mOrderBean.setEgent(agent);
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        switch (checkedId) {
            ...
            case R.id.rb_TA:
                mOrderBean.setStoreAddr("新鲜果业—泰安街店");
                break;
            case R.id.rb_HC:
                mOrderBean.setStoreAddr("新鲜果业—荟萃路店");
                break;
            case R.id.rb_AX:
                mOrderBean.setStoreAddr("新鲜果业—爱乡路店");
                break;
        }
    }
}
