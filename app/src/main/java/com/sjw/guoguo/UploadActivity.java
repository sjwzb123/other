...
public class UploadActivity extends BaseActivity {
    ...
    private EditText mEtActDis;
    private EditText mEtActPrice;
    ...
    public void initView() {
        mEtActPrice = (EditText) findViewById(R.id.et_act_price);
        mEtActDis = (EditText) findViewById(R.id.et_act_dis);
    ...
    private void upload() {
        ...
        String actDis = mEtActDis.getText().toString();
        String actPrice = mEtActPrice.getText().toString();
        Goods goods = new Goods();
        goods.setGoodCutPrice(Float.valueOf(actPrice));
        goods.setShareDis(actDis);
